...
Module.register("SmartMirror-Main-Menu-Tiles", {
	defaults: {
		menuObj: {
			...
			camera: {
				...
				face: { title: "Face Detection", icon: "fa fa-user-circle", topic: "LABEL_DISPLAY", message: "FACE" },
				objects: { title: "Object Detection", icon: "fa fa-coffee", topic: "LABEL_DISPLAY", message: "OBJECT" },
				gesture: { title: "Gesture Detection", icon: "fa fa-thumbs-up", topic: "LABEL_DISPLAY", message: "GESTURE" },
				SHOWALL: { title: "Show All Detections", icon: "fa fa-eye", topic: "LABEL_DISPLAY", message: "SHOWALL" },
				//person: { title: "Show Person Recognition", icon: "fa fa-users", topic: "LABEL_DISPLAY", message: "PERSON" },
				emo: { title: "Emotion Recognition", icon: "fa-regular fa-face-smile", topic: "LABEL_DISPLAY", message: "EMO" },
				HIDEALL: { title: "Hide All", icon: "fa fa-eye-slash" , topic: "LABEL_DISPLAY", message: "HIDEALL" },
	...
	hoverColor: 'rgb(0, 0, 0)', // Color of hovered element
